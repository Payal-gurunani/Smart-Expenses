...
//         if (!budgetManuallyUpdated && fetchedBudget !== null) {
//           setBudgetInput(fetchedBudget.toString());
//         }
//       }
//     } catch (err) {
...
//   // console.log(monthlyBudget,"91");
//   console.log("BudgetInput:", budgetInput, "MonthlyBudget:", monthlyBudget);
